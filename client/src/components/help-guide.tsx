        ...
        <Tabs defaultValue="basics" className="flex-1 overflow-hidden flex flex-col">
          ...
          <TabsContent value="assignments" className="flex-1 overflow-y-auto mt-4 pr-1">
            ...
            <Section title="Linked task groups">
              <Item label="What they are" description="Tie several cards together as one piece of work — for example a library prep that runs Monday to Friday as 5 cards. Linked cards show a chain (🔗) badge and are joined by an amber connector line in the week view; hovering one highlights every card in the group with an amber ring and emphasises the line." />
              <Item label="Aligned position" description="Linked cards always sit at the same position within their cells. Dragging one member to the top of its cell moves the whole group to the top across all of its days." />
              ...
              <Item label="Edit all at once" description="When you save changes to a linked card in the Task Details drawer, a popup asks whether to apply them to only that card or to every card in the group — covering batch number, size, notes, instrument, Slack toggles (and custom name/colour for Custom Tasks)." />
